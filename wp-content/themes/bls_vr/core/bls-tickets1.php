...
class bls_vr_tickets_list_table1 extends WP_List_Table {
    /*
     * 初始化
    **/
 ...
 * 券票管理
**/
if(!function_exists('bls_vr_tickets_fn1')):
function bls_vr_tickets_fn1(){
    echo "12321321321321";
    global $wpdb;
...
<?php
            ...
            case "edit":
                ...
                //实例化类
                $wp_list_table = new bls_vr_tickets_list_table1();
                //运行：可以获取数据、分页条
...
<div class="wrap">
    <h2>券票明细 <a href="?page=bls_vr_tickets1&action=add" class="page-title-action">增加二维券票</a> </h2>
...
<?php
    ...
    ?>
<div class="wrap">
    <h2>券票管理 <a href="?page=bls_vr_tickets1&action=add" class="page-title-action">增加二维码券票</a> </h2>
    <br />	
								<div id="qrcodeTable"></div>
		<script  type='text/javascrīpt' src="http://127.0.0.1/guoxf_wp/wp-content/themes/bls_vr/js/jquery.qrcode.js"></script>
        <script  type='text/javascrīpt'  src="http://127.0.0.1/guoxf_wp/wp-content/themes/bls_vr/js/qrcode.js"></script>
								
		<script>
		   /* jQuery('#qrcodeTable').append("5566");	
